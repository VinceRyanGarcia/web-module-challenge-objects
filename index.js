...
const pasta = createMenuItem("pasta", 1, "lunch");
const salad = createMenuItem("salad", 1, "lunch");
console.log(pizza, pasta, salad);
...
reviews.push({ name: "vince", rating: 1, feedback: "dope", });
// console.log (reviews) 
